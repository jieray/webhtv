package com.hemu.android.tv.db;
...
import com.hemu.android.tv.db.dao.ConfigDao;
import com.hemu.android.tv.db.dao.DeviceDao;
import com.hemu.android.tv.db.dao.HistoryDao;
import com.hemu.android.tv.db.dao.KeepDao;
import com.hemu.android.tv.db.dao.LiveDao;
import com.hemu.android.tv.db.dao.SiteDao;
import com.hemu.android.tv.db.dao.TrackDao;
import com.hemu.android.tv.utils.FileUtil;
import com.hemu.android.tv.utils.Formatters;
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static void backup() {
        backup(new com.hemu.android.tv.impl.Callback());
    }

    public static void backup(com.hemu.android.tv.impl.Callback callback) {
        Task.execute(() -> {
    ...
    public static void restore(File file, com.hemu.android.tv.impl.Callback callback) {
        Task.execute(() -> {
